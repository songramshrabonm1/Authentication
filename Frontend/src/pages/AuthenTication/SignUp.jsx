    ...
    <div>
      <div className="flex flex-col items-center justify-center  w-ful">
        ...
        <p className="text-white mt-4 text-center">
          Sign up and select your role (User, Author, or Rider) to access your
            ...
            <button
              ...
              style={
                Role == r ? (
                  ...
                  //   className="absolute left-0 right-0 top-0 h-7 -z-1 bg-[#e64323] text-white "
                  // ></motion.div>
                ) : (
      ...
      <main>
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {Role === "owner" && <OwnerSignUp></OwnerSignUp>}
            {Role === "deliveryBoy" && <RiderSignUp></RiderSignUp>}
          </motion.div>
        </AnimatePresence>
      </main>
    </div>
